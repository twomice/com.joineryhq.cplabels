<?php
/*
 * Forked from CiviCRM 5.12.3 by Allen Shaw for com.joineryhq.cplabels
 * Mofications are bookended with comments:
 * "BEGIN MODIFICATION for com.joineryhq.cplabels"
 * and
 * "END MODIFICATION for com.joineryhq.cplabels"
 * 
 +--------------------------------------------------------------------+
 | CiviCRM version 5                                                  |
 +--------------------------------------------------------------------+
...
class CRM_Contact_Form_Task_Label extends CRM_Contact_Form_Task {
  ...
  public function postProcess() {
     ...
     * BEGIN MODIFICATION for com.joineryhq.cplabels.
     */
    $rows = CRM_Cplabels_Utils::sortLabelRows($rows, $fv);
    /*
     * END MODIFICATION for com.joineryhq.cplabels.
     * *********
     */
