...
class CRM_Cplabels_Form_Search_Cplabels_Volunteer extends CRM_Contact_Form_Search_Custom_Base implements CRM_Contact_Form_Search_Interface {
  ...
  public function buildForm(&$form) {
    ...
    $this->setTitle(E::ts('Mailing Labels: Team Volunteers'));
    ...
    $form->addElement('select', 'serve_type', E::ts('Service type'), $serveType, array('class' => 'crm-select2 huge', 'multiple' => TRUE));
    ...
    $form->addElement('select', 'correspondence_type', E::ts('Correspondence type'), $correspondenceTypeOptions, array('class' => 'crm-select2 huge'));
